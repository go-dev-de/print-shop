    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white w-full max-w-md rounded-xl shadow p-6 space-y-4">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-gray-800 mb-2">Имя</label>
            <input 
              value={name} 
        ...
        <div className="text-sm text-gray-700">
          Уже есть аккаунт? <Link className="text-blue-600 hover:underline" href="/login">Войти</Link>
        </div>
      </div>
    </div>
  );
